  ...
  <div id="sideBar" class="side-bar d-block d-md-none d-flex justify-content-center align-items-center">
        ...
        <ul class="list-unstyled">
            <li class="mb-3">
                <a class="text-decoration-none tx-main text-uppercase fw-bold" href="{{ route('announcement.new') }}">{{__('ui.newAdd')}}</a>
            </li>
            @guest
            @if (Route::has('login'))
            <li class="mb-3">
            ...
            <li class="mb-3">
                <a class="text-decoration-none tx-main text-uppercase fw-bold" href="{{route('register')}}">{{__('ui.register')}}</a>
            </li>
            @endif
            @else
            <li class="mb-3">
                ...
                <a class="text-decoration-none tx-main text-uppercase fw-bold"  id="logoutBtn" class="" href="#">{{__('ui.logout')}}</a>
            </li>    
            @endguest
            <li class="mb-3">
